...
/**
 * Declaro que este trabalho foi realizado apenas pelo(a)(s) seguintes
 * aluno(a)(s): - NOME COMPLETO ----------------- MATRÍCULA
 * 
 * 1.Alícia Rita Oliveira Dos Reis 17/0129306
 * 
 * 2.Pedro Henriques Nogueira 14/0065032
 * 
 * 3.João Pedro de Salles Braga 13/0143049
 * 
 */
...
public class InterfaceTextual {
    ...
    public static void init() {
        ...
        /*
         * A classe Scanner ajuda a ler dados da entrada, represtentada pelo objeto
         * System.in. A documentacao desta classe esta na URL abaixo: http
        ...
        /*
         * use a linha abaixo para garantir que valores em ponto flutuante sao lidos
         * esperando-se um ponto e nao uma virgula para a parte decimal: por exemplo,
         * sera esperado 2.3 e nao 2,3
         */
    ...
    public static void trata_opcao(int opcao) {
        ...
        switch (opcao) {
            ...
            case OP_CRIAR_CONTA:
                ...
                System.out
                        .println("Favor entre o tipo da conta (1-Conta/2-Poupanca/3-Conta Bonificada) e  tecle Enter:");
                tipo = sc.nextInt();
                sc.nextLine();
            ...
            case OP_DEBITAR_CONTA:
                ...
                if (cod_retorno == 1) {
                    ...
                    System.out.println("!!!debitar em conta falhou, conta nao existe");
                }
