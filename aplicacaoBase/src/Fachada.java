public class Fachada {
	...
	public void descadastrarCliente(String cpf) {
		// descadastra primeiro as contas do cliente, pois nao faz sentido conta sem
		// cliente
	...
	public int atualizar(Conta c) {
		...
		// informa a mudanca ao cadastro: isto eh importante para fins de consistencia
		// do estado da conta
	...
	public Integer renderBonus(String numero) {
		int r = -1;
		Conta conta = null;
		...
		if (conta instanceof ContaBonificada) {
			if (conta.getSaldo() > 0) {
				...
				System.out.println("!!! Conta nao tem saldo para efetuar operacao");
			}
		} else {
			System.out.println("!!! Conta bonificada não existente");
		}
		return r;
	}

	public Integer renderJuros(String numero, double valor) {
		int r = -1;
		Conta conta = null;
		...
		if (conta instanceof Poupanca) {
			if (conta.getSaldo() > 0) {
				...
				((Poupanca) conta).renderJuros(valor);
				r = 1;
			} else {
				System.out.println("!!! Conta não tem saldo para efetuar operação");
			}
		} else {
